...
const multerStorage_1 = __importDefault(require("../utils/multerStorage"));
const authConroller_1 = require("./../controller/authConroller");
const userController_1 = require("./../controller/userController");
const userRouter = express_1.default.Router();
userRouter.post('/register', multerStorage_1.default, userController_1.signUp);
userRouter.post('/login', userController_1.login);
userRouter.patch('/Update_me/:id', authConroller_1.isAuthenticated, multerStorage_1.default, userController_1.updateProfile);
userRouter.patch('/reset_Password/:Token', authConroller_1.isAuthenticated, userController_1.resetPassword);
